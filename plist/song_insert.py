...
# connect to MySQL
con = pymysql.connect(host = '192.168.0.12',user = 'project',passwd = 'project',db = 'project_db')
cursor = con.cursor()
print(con,cursor)
...
for i, item in enumerate(json_obj):
    ...
    cursor.execute("INSERT INTO plist_song (song_title,song_artist,song_url,song_genre,song_tag,song_detail) VALUES (%s,%s,%s,%s,%s,%s)", (song_title,song_artist,song_url,song_genre,song_tag,song_detail))
